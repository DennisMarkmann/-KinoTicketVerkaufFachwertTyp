...
/**
 * Widget, das die Plätze in einem Kinosaal grafisch darstellt und es ermöglicht, Plätze für den Verkauf auszuwählen.
 *
 * Hierfür wurde ein eigenes Widget entwickelt, damit das Werkzeug nur einen Listener für ein spezielles Auswahl-Event
 * registrieren muss, statt an jedem einzelnen Button einen ActionListener registrieren zu müssen. Dieses Widget kapselt also
 * die Abbildung der Events der einzelnen Buttons auf ein Auswahl-Event.
 *
 * @author SE2-Team
 * @version SoSe 2016
 */
class JPlatzplan extends JComponent {
    ...
    /**
     * Fügt einen Listener hinzu, der bei Änderungen der Auswahl benachrichtigt wird.
     *
    ...
    /**
     * Erzeugt und registriert den Listener, der darauf reagiert, wenn durch Drücken eines der Buttons ein Platz ausgewählt
     * wird.
     */
    ...
    private void informiereSelectionListener(Set<Platz> ausgewaehltePlaetze) {
        PlatzSelectionEvent event = new PlatzSelectionEvent(this, ausgewaehltePlaetze);
     ...
     * Methode werden zunächst alle Plätze als frei angezeigt!
     *
