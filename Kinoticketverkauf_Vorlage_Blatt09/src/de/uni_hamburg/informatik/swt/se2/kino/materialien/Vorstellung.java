 ...
 * eigentlichen Vorstellung (wann und wo läuft welcher Film) und zum anderen, welche Plätze für diese Vorstellung bereits
 * verkauft wurden.
 *
 * @author SE2-Team
 * @version SoSe 2016
...
public class Vorstellung
{
    ...
    public Geldbetrag getPreisFuerPlaetze(Set<Platz> plaetze)
    {
        ...
        return _geldbetrag.multipliziere(plaetze.size());
    }
    ...
    /**
     * Prüft, ob ein gegebener Platz stornierbar ist. Dafür wird geschaut, ob ein gegebener Platz verkauft ist.
     *
    ...
    /**
     * Prüft, ob ein gegebener Platz verkauft werden kann. Dafür wird geschaut, ob der gegebene Platz bisher verkauft ist.
     *
    ...
    /**
     * Prüft, ob die gegebenen Plätze alle stornierbar sind. Dafür wird geschaut, ob jeder gegebene Platz verkauft ist.
     *
    ...
    /**
     * Prüft, ob gegebene Plätze alle verkauft werden können. Dafür wird geschaut, ob keiner der gegebenen Plätze bisher
     * verkauft ist.
     *
