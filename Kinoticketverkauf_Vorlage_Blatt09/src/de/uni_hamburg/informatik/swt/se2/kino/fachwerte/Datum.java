 ...
 *
 * Das Klassenobjekt stellt zwei Hilfsmethoden zur Verfügung, um das heutige Datum zu ermitteln und zu überprüfen, ob drei
 * Ganzzahlen ein gültiges Datum bilden.
 *
 * @author SE2-Team
 * @version SoSe 2016
 */
public final class Datum implements Comparable<Datum> {
     ...
     *
     * Alle Exemplare der Klasse Datum teilen sich ein veränderliches Calender-Objekt. Dieses Vorgehen ist extrem untypisch für
     * Fachwerte. Also nehmt diese Klasse bitte nicht als Musterbeispiel für Fachwerte! Orientiert euch lieber an den Klassen
     * Uhrzeit oder Geldbetrag.
     *
     * Die Klassen java.util.Date und java.util.Calendar sind so schrecklich, dass sie in Java 8 durch das Paket java.time
     * abgelöst wurden: http://www.oracle.com/technetwork/articles/java/jf14-date-time-2125367.html
     */
     ...
     * @param jahr Das Jahr.
     *
     * @return true wenn drei übergebene Zahlen ein gültiges Datum ergeben, ansonsten false.
     */
    ...
    /**
     * Subtrahiert von diesem Datum eine übergebene Anzahl an Tagen und gibt das Ergebnis als neues Datum zurück.
     *
    ...
    /**
     * Addiert auf dieses Datum eine übergebene Anzahl von Tage und gibt das Ergebnis als neues Datum zurück.
     *
    ...
    /**
     * Berechnet, wie viele Tage seit dem angegebenen Datum bis zu diesem Datum vergangen sind.
     *
